...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-CEIRKqnH.mjs");
...
//#endregion
export { server_default as default, createStart as t };
